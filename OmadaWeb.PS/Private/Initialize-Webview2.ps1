                    ...
                    try {
                        $Script:Timer.Add_Tick({
                                ...
                                try {
                                    ...
                                    if ($Script:WebView2.Source -eq "about:blank" -and (-not $Script:CurrentWebView2Session.ForceAuthentication -or $Script:CurrentWebView2Session.BrowserDataCleared)) {
