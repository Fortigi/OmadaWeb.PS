function Set-RequestParameter {
    ...
    if ($InvokeOmadaRequest) {
        ...
        $ExcludedParameters = @("SkipCookieCache", "CookiePath", "InPrivate", "ForceAuthentication", "AuthenticationType", "EntraIdTenantId", "RequestType", "EdgeProfile", "UseWebView2", "EntraApplicationIdUri", "OAuthUri", "OAuthScope", "DebugWebView2", "Paged")
    }
