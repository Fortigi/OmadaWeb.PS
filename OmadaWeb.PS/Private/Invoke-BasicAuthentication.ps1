function Invoke-BasicAuthentication {
    ...
    # (in the now-copied Headers dictionary - see Invoke-OmadaRequest.ps1), and the Basic
    # authentication the caller asked for here overrides it rather than throwing on a duplicate key.
